<template>
      ...
      <div class="message-content">
        ...
        <div class="text-container">
          ...
          <div v-else class="w-full">
            ...
            <button @click="sendResponse" class="p-3 bg-blue-500 text-white rounded-lg w-full hover:bg-blue-600 transition duration-300 transform hover:scale-105">
              Enviar
            </button>
          </div>
        </div>
  ...
  export default defineComponent({
    ...
    props: {
      message: {
        type: Object as PropType<{ text: string; isUser: boolean }>,
        required: true,
      },
      isUser: {
        type: Boolean,
  ...
  /* Adicione este estilo para ajustar o tamanho do ícone */
  .pi {
    font-size: 1.2rem;
  }
  </style>
